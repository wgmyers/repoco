...
function load_sites() {
  //const data = {
  //  "example.com": load_site("example.com"),
  //  "vmyers.com": load_site("vmyers.com")
  //};
  //const data = load_site("example.com");
    ...
    result: [
      {
        ...
        folder: true,
        expanded: true,
        children: load_site("example.com")
      },
      {
        title: "vmyers.com",
        folder: true,
        expanded: true,
        children: load_site("vmyers.com")
      }
